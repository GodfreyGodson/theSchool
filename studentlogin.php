            ...
            <div class="col-md-12">
                <div class="educa-register-context">
                    ...
                    <div class="educa-register-right">
                        ...
                        <div id="success-message" style="color: green; margin-top: 10px; display: none;">Logged in successfully!</div>
...
//   // If validation passes, save user in session
...
// });
  ...
  loginForm.addEventListener('submit', async (e) => {
    ...
    if (response.ok) {
      // User authenticated successfully, save user to session and redirect to protected page
     sessionStorage.setItem('user', JSON.stringify(data));
      console.log(data.user);
      console.log(data.token)
      successMessage.style.display = "block";
      errorMessage.style.display = "none";
      window.location.href = 'studentarea/dashboard.php';
    } else {
