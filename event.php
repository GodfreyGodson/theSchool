        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="educa-single-event">
                    ...
                    <div class="educa-event-content">
                        <a href="javascript:void(0)" class="educa-event-title">Titration</a>
                        <p class="educa-event-info"><span><i class="fal fa-clock"></i> 09:00PM - 13.00 PM</span> <span><i class="fal fa-map-marker"></i> Temeke 7-7, Dar es Salaam</span></p>
                        You will Learn basic to advanced practical skills.
                    </div>
                    <div class="educa-event-img">
                        <img src="https://chemicals.ie/wp-content/uploads/2021/09/illustration-of-how-titration-works-744x600.jpg" alt="event">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="educa-single-event">
                    ...
                    <div class="educa-event-content">
                        <a href="javascript:void(0)" class="educa-event-title">Chemical Kinetics</a>
                        <p class="educa-event-info"><span><i class="fal fa-clock"></i> 08:00PM - 10.00 PM</span> <span><i class="fal fa-map-marker"></i> Temeke, Dar es Salaam</span></p>
                        You will learn actual skill-set for passing kinetics practical.
                    </div>
                    <div class="educa-event-img">
                        <img src="https://www.chemedx.org/sites/www.chemedx.org/files/ts_pick_2-17_0.gif" alt="event">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <div class="educa-single-event">
                    ...
                    <div class="educa-event-content">
                        <a href="javascript:void(0)" class="educa-event-title">Compounds of Metal</a>
                        <p class="educa-event-info"><span><i class="fal fa-clock"></i> 10:00PM - 14.00 PM</span> <span><i class="fal fa-map-marker"></i> 7-7 Area, Dar es Salaam</span></p>
                        You will Learn all the skills for observing both chemical and physical behaviours of metals and their coumpounds.
                    </div>
                    <div class="educa-event-img">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTV0QNXKSVPhajn5h_Af4_MJSWcc-Zq5DqZtQ&usqp=CAU" alt="event">
                    </div>
                </div>
            </div>
            <!-- <div class="col-md-12">
