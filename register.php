            ...
            <div class="col-md-12">
                <div class="educa-register-context">
                    <div class="educa-register-left">
                        <h2>Learn Various courses with Us</h2>
                        <p>Register with us to get more learning materials, notes, exams, tests, past papers as well as practicals.</p>
                    </div>
                    <div class="educa-register-right">
                        ...
                        <form action="#" method="POST">
                            ...
                            <button type="submit" class="educa-register-btn">Register Now <i class="fal fa-sign-out"></i></button>
                        </form>
...
// Hide the student option
const userTypeSelect = document.querySelector('#userType');
userTypeSelect.options[0].style.display = 'none';
</script>
